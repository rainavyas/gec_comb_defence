...
def combined_args():
    parser = argparse.ArgumentParser(allow_abbrev=False)
    parser.add_argument('--combination', type=str, choices=['mbr', 'maxvote', 'greco'], default='mbr', help='method of combination.')
...
def attack_args():
    ...
    parser.add_argument('--super_sample', action='store_true', help='Train with very small training set sample')
